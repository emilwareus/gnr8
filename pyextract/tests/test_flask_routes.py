...
class FlaskRouteTests(unittest.TestCase):
    ...
    def test_diagnostic_messages_match_snapshot_byte_for_byte(self):
        ...
        self.assertEqual(
            diagnostics["request.parameter.unresolved"]["operation"], "GET /orders/"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            diagnostics["request.body.unresolved"]["operation"], "POST /orders/raw"
        )
        self.assertEqual(
            diagnostics["request.body.unresolved"]["category"], "request_body"
        )
        self.assertEqual(
            diagnostics["response.schema.unresolved"]["operation"], "POST /orders/raw"
        )
        self.assertEqual(
