...
- [x] 03-02-PLAN.md — PySdk Target built-in (clone GoSdk: sdk_package reuse, ir.base_path, safe-name guard, output_anchors), prelude export, unconfigured-error test [PYSDK-03]
