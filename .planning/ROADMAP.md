...
- ✅ **v3.0 — Production-ready SDK adoption** — Phases 1-5 (shipped 2026-07-09)

> **Phase numbering note:** each milestone's phases are numbered from 1. The v1.0 phases are archived
> under `.planning/milestones/v1.0-*`; the v2.0 phases under `.planning/milestones/v2.0-*`; the v3.0
> phases under `.planning/milestones/v3.0-*`.
...
<details open>
<summary>✅ v3.0 Production-ready SDK adoption (Phases 1-5) — SHIPPED 2026-07-09</summary>

Full requirements: `.planning/milestones/v3.0-REQUIREMENTS.md` · Audit:
`.planning/milestones/v3.0-MILESTONE-AUDIT.md` · Research: `thoughts/research/adoption-support.md`
...
- [x] Phase 3: Stable SDK Surface And Readiness — completed 2026-07-09.
- [x] Phase 4: SDK Runtime Ergonomics — completed 2026-07-09.
- [x] Phase 5: API Metadata And Common Content Types — completed 2026-07-09.
...
| 3. Stable SDK Surface And Readiness | v3.0 | 3/3 | Complete | 2026-07-09 |
| 4. SDK Runtime Ergonomics | v3.0 | 3/3 | Complete | 2026-07-09 |
| 5. API Metadata And Common Content Types | v3.0 | 2/2 | Complete | 2026-07-09 |
