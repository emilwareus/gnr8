...
- [x] **META-01**: A `.gnr8` pipeline author can configure operation summary, description, deprecation, tags,
  response descriptions, and documented error responses using selector-based transforms.
- [x] **META-02**: A `.gnr8` pipeline author can configure named request/response examples for operation media
  types.
- [x] **META-03**: Generated OpenAPI and SDK docs propagate operation metadata, examples, deprecation notes,
  tags, and documented error responses.
- [x] **MEDIA-01**: Generated OpenAPI and SDKs support JSON, `text/plain`, `application/x-www-form-urlencoded`,
